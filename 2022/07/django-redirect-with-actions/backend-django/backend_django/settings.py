...
from backend_django.support.django_helpers import eval_env_as_boolean
from backend_django.support.django_helpers import getenv_or_raise_exception
...
AUTH0_CONTINUE_ENDPOINT = f"https://{AUTH0_DOMAIN}/continue"
...
AUTH0_JWT_SECRET = getenv_or_raise_exception("AUTH0_JWT_SECRET")

OIDCProvider.configure_class_properties(
    AUTH0_DOMAIN, AUTH0_MY_APPLICATION_KEY, AUTH0_MY_APPLICATION_SECRET, AUTH0_SCOPES
)
