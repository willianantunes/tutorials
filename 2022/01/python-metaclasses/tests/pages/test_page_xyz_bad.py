...
from python_metaclasses.pages.page_xyz_bad import MyPageXYZSampleBad


class MyPageXYZSampleBadTests(unittest.TestCase):
    @mock.patch("python_metaclasses.decorators.logger")
    def test_should_take_screenshots_when_required(self, mocked_logger):
        # Arrange
        my_page_sample_instance = MyPageXYZSampleBad()
        # Act
