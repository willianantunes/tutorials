...
def accept_fake_access_token(mocker):
    mock_class = mocker.patch("cache_django.apps.core.api.authentication.authentications.CachingJWKClient")
    mock_class.return_value = mocker.MagicMock()
    mocked_jwt = mocker.patch("cache_django.apps.core.api.authentication.authentications.jwt")
    fake_data = {
