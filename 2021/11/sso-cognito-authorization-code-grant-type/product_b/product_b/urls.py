...
from product_b import settings
from product_b.apps.core import views
from product_b.apps.core.api import api_views
from product_b.apps.core.api.v1 import api_views as api_views_v1
