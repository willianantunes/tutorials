...
from product_b.apps.core.apps import CoreConfig
...
WSGI_APPLICATION = "product_b.wsgi.application"
...
SESSION_COOKIE_NAME = "product_b_sessionid"
...
AWS_COGNITO_PROVIDED_DOMAIN = f"cognito-idp.{AWS_COGNITO_REGION}.amazonaws.com/{AWS_COGNITO_USER_POOL_ID}"

AWS_COGNITO_APP_CLIENT_ID = "AWS_COGNITO_APP_CLIENT_ID"
AWS_COGNITO_APP_CLIENT_SECRET = "AWS_COGNITO_APP_CLIENT_SECRET"
AWS_COGNITO_APP_SCOPES = ["openid", "email", "profile"]
